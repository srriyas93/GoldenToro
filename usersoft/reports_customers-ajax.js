...
function TransactionReport(event){
	...
	var url = "reports_customers-ajax.php?mode=TransactionReport&username="+username+"&cust_snoname="+cust_snoname+"&cust_planid="+cust_planid+"&cust_start_date="+cust_start_date+"&cust_end_date="+cust_end_date; // the script where you handle the form input.
