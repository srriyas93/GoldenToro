...
<!-- Include Other Files -->
<?php 
    include('reports_plans-ajax.php');
?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div id="CustomerSearch" class="report_card">
                    <div class="header">
                        <h2><strong>Plans</strong> Report</h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="form-group">
                                    <select id="plan_report_planid" name="plan_report_planid" class="form-control" required>
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="form-group">
                                    <select id="plan_report_custid" name="plan_report_custid" class="form-control" required>
                                        ...
                                        $q = "SELECT cust_id, name FROM users_customers WHERE cust_type=1";
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="plan_report_start_date" id="plan_report_start_date" class="form-control datepicker" placeholder="Please choose date ...">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="plan_report_end_date" id="plan_report_end_date" class="form-control datepicker" placeholder="Please choose date ...">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4" style="margin-top:20px;">
                            <button class="btn btn-primary btn-round"  onClick="PlansReport(event);"> Generate Report </button>
                            </div>
                        </div>
